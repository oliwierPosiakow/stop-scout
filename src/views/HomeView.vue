...
const goToStop = (stopId: number) => {
  router.push({ name: 'stop', params: { id: stopId } });
};
    ...
    <section>
      <div class="mb-3">
        ...
        >
          ...
          <p class="text-ios-sm text-gray-400 dark:text-gray-500">
        ...
        <div v-else class="space-y-3">
          ...
          >
            ...
            <p
              v-if="fav.notes"
              class="text-ios-sm text-gray-600 dark:text-gray-300 mb-3 py-2 px-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-ios-lg italic border-l-2 border-yellow-500"
            >
              {{ fav.notes }}
            </p>
            ...
            <div class="flex gap-2">
              ...
              <button
                ...
                class="px-3 py-2 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 rounded-ios-lg font-semibold text-ios-base active:opacity-60"
